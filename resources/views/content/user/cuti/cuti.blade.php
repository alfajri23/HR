        ...
        <div class="widget-bg">
            <div class="widget-body">
                ...
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-success btn-sm mb-2" data-toggle="modal" data-target="#izinModal">Ajukan cuti</button>
                </div>
        ...
        <div class="modal-body">
            <form action="{{route('izinReq')}}" method="POST">
                ...
                <div class="form-row pl-3">
                    ...
                    <input type="hidden" class="form-control" name="jenis" id="jenis" value="cuti">
                </div>
